...
public class ExchangeRateErrorHandling {
    ...
    public static void main(String[] args) {
        ...
        // Note that this server will take ~10 seconds to respond the first time you run the program.
        ...
        //String exchangeRateURL = "https://exchange-rates-1150.herokuapp.com/latestPizza";
